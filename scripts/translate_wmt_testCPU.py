...
def main():
    ...
    sp_model_path = "models/spm_ru_en.model"
    test_input_file = "data/test_preprocessed_ru.txt"
    output_file = "data/wmt_test_translations_beam_cpu.txt"
    ...
    if use_beam_search:
        ...
        translator = Translator(model_path, sp_model_path)
    
    # Translate file
    translator.translate_file(test_input_file, output_file)
