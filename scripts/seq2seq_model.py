...
class BaseEncoder(nn.Module):
    ...
    def get_initial_hidden_state(self, batch_size=1):
        ...
        raise NotImplementedError("Subclasses must implement get_initial_hidden_state method")
...
class AdditiveAttention(BaseAttention):
    ...
    def forward(self, decoder_hidden, encoder_outputs):
        ...
        decoder_hidden = decoder_hidden.repeat(1, seq_len, 1)  # [batch_size, seq_len, hidden_size]
        ...
        attn_inputs = torch.cat((decoder_hidden, encoder_outputs), dim=2)  # [batch_size, seq_len, hidden_size*2]
